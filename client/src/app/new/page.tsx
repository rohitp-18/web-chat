...
function Page() {
  return (
    <ProtectRoute>
      <Header hidden={false} />
      <div className="flex flex-col items-center justify-center min-h-screen md:p-6 p-2 bg-linear-to-br from-blue-50 to-indigo-100">
        <div className="bg-white rounded-2xl shadow-xl md:p-8 p-2 py-8 w-full max-w-lg">
          ...
          <div className="space-y-4">
            <Link href="/new/user" className="block p-2">
              <Button className="w-full flex items-center justify-start md:p-10 p-6 py-10 bg-white border-2 border-gray-200 text-gray-700 rounded-xl hover:border-blue-300 hover:bg-blue-50 transition-all duration-200 shadow-sm hover:shadow-md">
            ...
            <Link href="/new/group" className="block">
              <Button className="w-full flex items-center justify-start md:p-10 p-6 py-10 bg-white border-2 border-gray-200 text-gray-700 rounded-xl hover:border-green-300 hover:bg-green-50 transition-all duration-200 shadow-sm hover:shadow-md">
